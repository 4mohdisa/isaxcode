...
const Header: React.FC = () => {
  ...
  return (
    ...
    >
      <Image 
      src="/graphic-designs/Logo-Designing-Banner.jpg"
      className="absolute w-full h-full -z-10 object-cover opacity-80"
      width={7000}
      loading="lazy"
      height={1000}
      objectFit="cover"
      ...
      <div className="p-12 font-bold   z-10 text-white drop-shadow-[0_5px_3px_rgba(0,0,0,0.4)] text-center flex flex-1 items-center justify-center flex-col">
        <h1 className="mb-6 text-6xl tracking-wider lg:text-7xl ">Logo Designing</h1>
      </div>
      <div
