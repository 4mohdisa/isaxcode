...
const Header: React.FC = () => {
  ...
  return (
    ...
    >
      <Image 
      src="https://mir-s3-cdn-cf.behance.net/project_modules/1400/a0baf0180531245.650c2efd7ac19.jpg"
      ...
      <div className="p-12 font-bold   z-10 text-white drop-shadow-[0_5px_3px_rgba(0,0,0,0.4)] text-center flex flex-1 items-center justify-center flex-col">
        <h1 className="mb-6 text-6xl tracking-wider lg:text-7xl ">UI UX Designing</h1>
      </div>
      <div
