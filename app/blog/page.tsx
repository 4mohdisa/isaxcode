...
const BlogPostsPage = () => {
  ...
  return (
    <>
      ...
      />
      <div className='flex flex-row gap-8 p-5 md:p-10 lg:p-20 justify-center bg-black'>
        <div className='w-full md:min-w-[60%]'>
          <div className='md:hidden inline'>
          <SearchBar onSearch={handleSearch} />
          </div>
          <div className="grid grid-cols-1 mt-10  md:grid-cols-2 2xl:grid-cols-3 items-center justify-center gap-4 lg:gap-8 2xl:gap-4 mx-auto">
          {isLoading ? (
