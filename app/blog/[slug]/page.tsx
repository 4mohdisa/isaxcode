...
<div className='bg-black h-screen flex items-center justify-center w-full py-20'>
<div role="status" className=''>
  ...
  return (
    <div className='bg-black flex items-center justify-center w-full py-20'>
      ...
      <div className='px-5 lg:px-0 w-full lg:-[50%] blog-content-container text-white text-xl text-left flex flex-col items-center justify-center'>
